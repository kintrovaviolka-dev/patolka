...
const DATA_ONCO_2 = [
...

  {
    ...
    content: {
      ...
      microscopy: "Buňky jsou vysoce uniformní, mají kulatá jádra s chromatinem vzhledu **soli a pepře**. Rostou v ostrovy, čepy nebo trabekuly. V cytoplasmě jsou patrná neurosekreční granula, která se barví imunohistochemicky na **chromogranin A** a **synaptofyzin**.",
...

  {
    ...
    content: {
      ...
      etiology: "Vnější karcinogeny (strava, kouření) hrají minimální roli. Hlavní jsou genetické faktory: vrozené mutace tumor supresorových genů (např. **WT1, RB1, TP53**), chromozomální abnormality (Downův syndrom zvyšuje riziko leukémií 20x) a poruchy embryonálního vývoje.",
...

  {
    ...
    content: {
      ...
      clinical: "Feochromocytom se projevuje **paroxysmální (záchvatovitou) arteriální hypertenzí** (extrémní vzestup tlaku při vyplavení adrenalinu), provázenou bušením srdce (tachykardií), bolestmi hlavy a pocením. V moči se detekují zvýšené hladiny metanefrinů a kyseliny vanilmandlové (VMA).",
...

  {
    ...
    content: {
      ...
      microscopy: "Papilární k.: papily a charakteristická jádra - **prázdná jádra vzhledu Sirotka Aničky** (Orphan Annie eyes - chromatin je odtlačen k okrajům jádra) a jaderné pseudoinkluze. Přítomnost psamomatózních tělísek. Medulární k.: polygonální buňky v hnízdech, stroma obsahuje růžová depozita **amyloidu** (tvořeného prokalcitoninem - pozitivní v barvení Kongočervení).",
    ...
    quiz: [
      {
        ...
        options: [
          ...
          "Opticky prázdná, světlá jádra s chromatinem kondenzovaným při jaderné membráně a jadernými zářezy (pseudoinkluzemi)",
      ...
      },
      {
        ...
        correct: 1,
        explanation: "Medulární karcinom je neuroendokrinní tumor z parafolikulárních C-buněk, které fyziologicky produkují kalcitonin (snižuje hladinu vápníku). Nadbytek prokalcitoninu se sráží v mezibuněčném prostoru za vzniku specifického nádorového stroma bohatého na amyloid."
      }
    ,
      {
...

  {
    ...
    content: {
      definition: "Nádory kůže jsou vůbec nejčastějšími lidskými nádory. Dělí se na benigní (např. seboroická keratóza, dermatofibrom), prekancerózy (aktinická keratóza, Bowenova choroba) a maligní (bazocelulární a dlaždicobuněčný karcinom).",
...

  {
    ...
    content: {
      ...
      etiology: "U osteosarkomu: mutace tumor supresorových genů **RB1** (častý výskyt u pacientů, kteří přežili retinoblastom) a **TP53** (Li-Fraumeni syndrom). U starších pacientů vzniká na podkladě Pagetovy kostní choroby. U Ewingova sarkomu: specifická reciproké translokace **t(11;22)**.",
