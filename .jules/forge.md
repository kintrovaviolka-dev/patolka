...
## 2025-01-20 - English words mixed into Czech content
**Learning:** Found an English word ("tissue") mistakenly mixed into a Czech sentence ("masivní sekrece bez destrukce tissue") within a medical description in `data_special_2.js`.
**Action:** When auditing data, look out for accidental English translations or untranslated words left in the Czech content files, especially in complex medical descriptions.
