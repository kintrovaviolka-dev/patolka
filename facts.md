...
PREKANCERÓZY A DYSPLÁZIE

-  Prekancerózy (premaligní léze) = vznikají v důsledku dysplastických změn,
...
-  Normální tkáň v abormální lokalizaci (př. tkáň nadledvin v ováriu → nádory
...
mastopatie v prstu (hmatatelné mikrocysty, důsledek přechodu)
...
BIOLOGICKÁ POVAHA NÁDORŮ

-  Dle biologického chování rozlišujeme benigní, maligní a borderline (nádory nejistého
...
KRITÉRIA BENIGNITY A MALIGNITY

-  Říct předchozí otázku + popsat stupně diferenciace u maligních nádorů
...
BENIGNÍ A MALIGNÍ EPITELIÁLNÍ NÁDORY

-  Vznikají buď z povrchového nebo žlázového epitelu
...
BENIGNÍ A MALIGNÍ MEZENCHYMÁLNÍ NÁDORY

-  Vychází z mezenchymálních buněk = fibroblasty, myofibroblasty, adipocyty, svalové
...
-  Nádorové buňky vznikají v KD a jsou vyplavovány do periferní krve → mohou
...
LYMFOMY B-ŘADY
Chronická lymfocytární leukémie/lymfom malých lymfocytů a Leukémie z vlasatých buněk
...
-  Tento nádory vychází již z terminálně diferencovaných B-lymfocytů (=plazmocytů) →
...
-  Mezenchymální nádory vznikající z endotelu nebo pericytů (podpůrné bb.)
...
-  V srdci nám převažují zjm. sekundární nádory, zjm. v perikardu
...
-  V plicích převažují sekundární nádory (metastázy), z primárních dominují epitelové
...
-  Převaha sekundárních nádorů, primární jsou vzácné
...
vrstvy epidermis) → solidární nebo trabekulární uspořádání → může přecházet
...
-  Ve střevě nejčastěji nacházíme polypy (adenomy), které mohou progredovat
...
-  Nejčastěji se zde vyskytují sekundární nádory (do jater mohou prakticky metastázovat
...
-  Neuroendokrinní diferenciace (buňky produkující hormony) → klasifikovány do 3
...
-  Nádory ledvin vychází z mezenchymu nebo tubulárních buněk → setkáme se zde, jak
...
-  Nejčastěji (až 95%) se zde setkáváme s acinárním adenokarcinomem prostaty, který
...
-  Nádory varlat hodnotíme dle TNM klasifikace, kde T (tumor, hodnotíme velikost
...
NÁDORY DĚLOHY A DĚLOŽNÍHO HRDLA
...
-  Primární nádory = epitelové, sex-cord, germinální
...
-  Trofoblast = zevní vrstva blastocysty, která dává vznik plodovým obalům a placentě,
...
-  Nejčastěji – onemocnění leukocytů (leukémie AML, ALL), i lymfomy (NHL I HL)
...
-  Pro odlišení benignity a malignity nám slouží Weissův skórovací systém (hodnocení
...
NÁDORY ENDOKRINNÍHO SYSTÉMU

-  Adenomy hypofýzy (specka), nádory nadledvin, nádory ŠŽ
...
-  Vysoce maligní nádor neuroektodermového původu → pokročilý a metastatický
...
-  Vzácná, benigní, etio neznámé (některé formy jsou spojené s neurofibromatózy)
...
NÁDORY MOZKU A MOZKOVÝCH OBALŮ
...
-  Nejčastější primární nádory CNS
